        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          class WorkspacesForeachCommand extends cli_1.BaseCommand {
            ...
            async execute() {
              ...
              const { project, workspace: cwdWorkspace } = await core_1.Project.find(
                configuration,
                this.context.cwd
              );
              ...
              for (const workspace of candidates) {
                ...
                if (
                  ...
                  !this.include.includes(core_3.structUtils.stringifyIdent(workspace.locator))
                )
                  continue;
                if (
                  this.exclude.length > 0 &&
                  this.exclude.includes(core_3.structUtils.stringifyIdent(workspace.locator))
                )
                  continue;
                    ...
                    for (const [identHash, workspace] of needsProcessing) {
                      ...
                      if (this.topological || this.topologicalDev) {
                        ...
                        for (const descriptor of resolvedSet.values()) {
                          ...
                          isRunnable =
                            workspace === null ||
                            !needsProcessing.has(workspace.anchoredLocator.locatorHash);
